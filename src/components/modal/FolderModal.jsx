...
export const FolderModal = ({ onCreate, floading }) => {
  ...
  return (
    <Modal>
      ...
      <ModalBody className="flex justify-center items-center">
        <ModalContent className="w-full max-w-md p-4 rounded-lg flex flex-col justify-center">
          ...
          <div className="flex justify-center">
            <button
              ...
              disabled={floading}
            >
              {floading ? <ClipLoader size={16} /> : "Create"}
            </button>
          </div>
        </ModalContent>
      </ModalBody>
